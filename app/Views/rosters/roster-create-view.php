...
<?= $this->section('content') ?>
    ...
    <div class="container">
        <br>
        <h3 class="text-center alert-info p-3">Roster Add</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- <form action="<?php //echo base_url('RosterControl/createOrUpdate'); ?>" name="OffdayControl_create" id="OffdayControl_create" method="post" accept-charset="utf-8"> -->
                <?php echo form_open(site_url('Rosters/createOrUpdate'), ['name' => 'RosterControl_create', 'id' => 'RosterControl_create', 'autocomplete' => 'off']); ?>

                <div class="form-group">
                    <label for="dept_id">Department name</label>
                    <!-- <input type="text" name="title" class="form-control" placeholder="Please enter title"> -->
                    <!-- <?php //$js = 'onchange="onChanges(this);"'; 
                            ?> -->
                ...
                <!-- <div class="form-group">
                    ...
                    <?php //echo form_input(['name' => 'name', 'class' => 'form-control', 'value' => set_value('name'), 'placeholder' => "Please enter First Name"]); 
                    ?>
                </div> -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                        <input type="text" name="roster_date" class="form-control datetimepicker-input" data-target="#datetimepicker1" />
    ...
    <script>
        if ($("#RosterControl_create").length > 0) {
            $("#RosterControl_create").validate({
